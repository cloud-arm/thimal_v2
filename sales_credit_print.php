        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            for ($i = 0; $row_cus = $customer->fetch(); $i++) {
                ...
                for ($i = 0; $row2 = $result2->fetch(); $i++) {
                  ...
                  if ($leval >= 0) {
                    ...
                    <tr style="background-color: <?php echo $color; ?>; color: <?php echo $color1; ?>">
                      ...
                      <td><?php if ($row['pay_amount'] > '0') {
                            echo number_format($row['pay_amount'], 1);
                            $pay_tot += $row['pay_amount'];
                          } ?></td>
              ...
              if ($b_tot > 1) {
                ...
                <tr class=" bg-gray">
                  ...
                  <td colspan="4">
                    <hr>
                    <h4> <?php echo  $cus_name; ?> ___ Total</h4>
                  </td>


                  <td>
                    <hr>
                    <h4><?php echo number_format($b_tot, 1); ?></h4>
                  </td>
                  <td>
                    <hr>
                    <h4><?php echo number_format($pay_tot, 1); ?></h4>
                  </td>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <h3><?php echo number_format($tot, 1); ?></h3>
              </td>
              <td></td>
