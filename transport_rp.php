        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                if (isset($_GET['d1']) & isset($_GET['d2'])) {
                            ...
                            $sql = "SELECT *,transport.amount AS am FROM transport JOIN transport_list ON transport.invoice_number = transport_list.invoice_no WHERE transport_list.dll = 0 AND transport_list.pu_date BETWEEN '$d1' AND '$d2' GROUP BY transport_list.invoice_no  ORDER BY transport_list.pu_date ";
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="transport_rp_print.php?invo=<?php echo base64_encode($row['invoice_number']); ?>" class="btn btn-warning btn-sm fa fa-eye"></a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                            <tfoot>
